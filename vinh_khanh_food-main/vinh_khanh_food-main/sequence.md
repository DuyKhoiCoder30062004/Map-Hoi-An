# Sequence Diagrams for VinhKhanh Food

Các sơ đồ sequence dưới đây mô tả luồng hoạt động thực tế của ứng dụng dựa trên code frontend và backend hiện tại.
...
Các sơ đồ trên được tạo dựa trên code thực tế của dự án VinhKhanh Food, bao gồm các API routes, luồng frontend/backend, và tương tác với database và external services như Google Gemini và ElevenLabs.